...
parser.add_argument('--decay_epoch', type=int, default=40, help='every n epochs decay learning rate')  # 100
parser.add_argument('--load', type=str, default=None, help='train from checkpoints')
parser.add_argument('--load_pre', type=str, default=None, help='train from checkpoints')
parser.add_argument('--gpu_id', type=str, default='0', help='train use gpu')
parser.add_argument('--fintuning', type=str, default=None, help='train from checkpoints')
parser.add_argument('--rgb_root', type=str, default='', help='the training rgb images root')  # train_dut
...
parser.add_argument('--edge_root', type=str, default='', help='the training rgb texture root')  # train_dut
